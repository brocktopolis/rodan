...
float ofDist(ofVec3f first, ofVec3f second){
	return ofDist(first.x, first.y, first.z, second.x, second.y, second.z);
}

float ofDist(ofVec2f first, ofVec2f second){
	return ofDist(first.x, first.y, second.x, second.y);
}
